...
export default function AnimatedGridPattern({
  ...
  useEffect(() => {
    const currentRef = containerRef.current; // Save the current ref value
    ...
    return () => {
      if (currentRef) {
        resizeObserver.unobserve(currentRef); // Use the saved ref value here
      }
    };
  }, []);
